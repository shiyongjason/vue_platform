<template>
    <div class="zfCutter">
        ...
        <button type="button" v-if="!$slots.openImgCutter && !$slots.open && isModal === true" class="btn btn-primary" @click="handleOpen">
            {{ label }}
        </button>
                    ...
                    <transition name="fade" enter-class="fade-in-enter" enter-active-class="fade-in-active" leave-class="fade-out-enter" leave-active-class="fade-out-active">
                        <div ref="dialogMainModalRef" :class="isModal === true ? 'dialogMainModal' : 'dialogMain'" :style="'width:' + (isModal === true ? boxWidth + 32 : boxWidth) + 'px'">
                            <div class="toolMain">
                                ...
                                <div ref="toolBox" :style="'height:' + boxHeight + 'px;width:' + boxWidth + 'px'" @mousemove="controlBtnMouseMove" @mouseup="controlBtnMouseUp" @mouseleave="controlBtnMouseUp" class="toolBox">
                                    <!--选取图片-->
                                    ...
                                    <div v-if="tool == true" v-show=" drawImg.img &&dropImg.active !== true &&controlBox.disable == true &&toolBox.disable == true" class="dockMain" :style="'background:' + toolBgc" @mouseenter="dropImgOff">
                                        ...
                                        <div v-if="originalGraph === false" @click="turnRefresh()" class="dockBtn">
                                            <slot name="reset"> 复位 </slot>
                                        </div>
                                        <div v-if="originalGraph === false" class="dockBtnScrollBar">
                                            <div ref="dockBtnScrollControl" @mousemove="scrollBarControlMove" @mousedown="scrollBarControlOn" @mouseleave="scrollBarControlOff" @mouseup="scrollBarControlOff" :style="'left:' + rotateControl.position + 'px'" class="scrollBarControl"></div>
                                            <div v-if="rotateControl.active == true" class="scrollBarText" :style="'left:' + rotateControl.position + 'px'">
                                    ...
                                    <!--裁剪区域-->
                                    <div v-show="drawImg.img != null" ref="toolBoxControl" @mousedown="toolBoxMouseDown" @mouseup="toolBoxMouseUp" @mousemove="toolBoxMouseMove" @mouseleave="toolBoxMouseLeave" class="toolBoxControl">
                                        <div class="toolBoxControlBox">
                                            <div class="controlBox">
                                                ...
                                                <!--操作杆-->
                                                <div data-name="leftUp" v-if="sizeChange === true" @mousedown="controlBtnMouseDown($event, 'leftUp')" class="leftUp controlBtn"></div>
                                                <div data-name="leftDown" v-if="sizeChange === true" @mousedown="controlBtnMouseDown($event, 'leftDown')" class="leftDown controlBtn"></div>
                                                <div data-name="rightUp" v-if="sizeChange === true" @mousedown="controlBtnMouseDown($event, 'rightUp')" class="rightUp controlBtn"></div>
                                                <div data-name="rightDown" v-if="sizeChange === true" @mousedown="controlBtnMouseDown($event, 'rightDown')" class="rightDown controlBtn"></div>

                                                <div data-name="topCenter" v-if="sizeChange === true && !rate && toolBox.width > 20" @mousedown="controlBtnMouseDown($event, 'topCenter')" class="topCenter controlBtn"></div>
                                                <div data-name="downCenter" v-if="sizeChange === true && !rate && toolBox.width > 20" @mousedown="controlBtnMouseDown($event, 'downCenter')" class="downCenter controlBtn"></div>
                                                <div data-name="leftCenter" v-if="sizeChange === true && !rate && toolBox.height > 20" @mousedown="controlBtnMouseDown($event, 'leftCenter')" class="leftCenter controlBtn"></div>
                                                <div data-name="rightCenter" v-if="sizeChange === true && !rate && toolBox.height > 20" @mousedown="controlBtnMouseDown($event, 'rightCenter')" class="rightCenter controlBtn"></div>
                                            </div>
                                    ...
                                    <!--画布-->
                                    <canvas class="canvasSelectBox" ref="canvasSelectBox" :width="boxWidth" @mousedown="dropImgOn" @mouseup="dropImgOff" @mousemove="dropImgMove" :height="boxHeight"></canvas>
...
export default {
    ...
    methods: {
        ...
        putImgToCanv (e) {
            ...
            this.copyDrawImg = file
            this.onRendFiles(file)
        ...
        putToolBox () {
            ...
            // 兼容 复原 的 裁截框
            if(this.copyToolBoxPosition){
                this.drawControlBox(this.copyToolBoxPosition.boxWidth, this.copyToolBoxPosition.boxHeight, this.copyToolBoxPosition.x, this.copyToolBoxPosition.y);
            }else{
                this.copyToolBoxPosition = {
                    x: this.toolBox.x,
                    y: this.toolBox.y,
                    boxWidth:this.toolBox.width,
                    boxHeight:this.toolBox.height,
                }
                                    ...
                                    newCanv.toBlob(
                                        (newBlob) => {
                                            ...
                                            if (!doNotReset) {
                                                ...
                                                console.log('%c [ _this.previewMode ]-1556', 'font-size:13px; background:pink; color:#bf2c9f;', _this.previewMode)
