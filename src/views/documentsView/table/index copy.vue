<template>
    <div class="home">
        ...
        <PExample :code="code">
            ...
            <commonTable isShowIndex ref="zfTable" isShowselection border stripe showPagination collapseShow align="center" :column="tableLabel" :data="newList" :pageNumber.sync="queryParams.pageNumber" :pageSize.sync="queryParams.pageSize" :total="page.total" @pagination="getList" actionWidth="120"
            :height="600"
                highlight-current-row @expand-change="expandSelect" row-key="id" :expand-row-keys="expands" expand :tree-props="{ children: 'children', hasChildren: 'hasChildren' }" show-summary isAction :isActionFixed="newList && newList.length > 0" @sort-change="sortChange" @cell-click="cellClick"
...
import { code, attrs, event, attrsSlot } from './code/index'
import commonTable from '@/components/HosJoyTable/common-table.vue'
...
export default class HomeView extends Vue {
    ...
    tableLabel = [
        ...
        { label: '插槽', prop: 'payAddress', slot: 'payAddress', width: '200', showOverflowTooltip: true },
        {
            label: '一级',
            children: [
                {
